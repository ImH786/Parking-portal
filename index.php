...
<body>
            ...
            <div class="row">
                <div class="col-md-12 text-center" id="header">
                   ...
                   <ul>
                       ...
                       <li><a href="booking_requests.php">Booking Request</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">                                 
                    <?php 
                     ...
                     $sql = "SELECT * FROM Vehicle_info WHERE Exit_date IS NULL"; // Modified query to exclude exited vehicles
                    ...
                    <div id="car">
                        ...
                        <?php
                            if($num != 50){
                                ...
                                echo "<h3>Sorry, no parking space available</h3>";
                            }
                        ?>
                    </div>
    ...
    <?php
    if (isset($_GET['booking_requests'])) {
                            ...
                            <tbody>
                                ...
                                if(mysqli_num_rows($booking_result) > 0){
                                    while ($booking_row = mysqli_fetch_assoc($booking_result)) {
                                        ?>
                                        <tr>
                                            <td><?php echo $booking_row['Owner_name']; ?></td>
                                            <td><?php echo $booking_row['Vehicle_name']; ?></td>
                                            <td><?php echo $booking_row['Vehicle_number']; ?></td>
                                            <td><?php echo $booking_row['Estimate_time']; ?></td>
                                            <td><?php echo $booking_row['Status']; ?></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
                                    echo "<tr><td colspan='5' class='text-center'>No booking requests found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
        ...
        const search = () => {
            ...
            for (var i = 0; i < tr.length; i++) {
                ...
                if (td) {
                    ...
                    tr[i].style.display = text_value.toUpperCase().indexOf(input_value) > -1 ? "" : "none";
                }
            }
        };
    </script>
